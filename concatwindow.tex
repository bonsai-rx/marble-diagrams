...
\matrix[row sep=0.5cm]
{
  ...
  \path let \p1 = (0x3x0) in node[marble,diamond,yellow] (3x2) at (\x1+0.85cm,0) {};
  \path let \p1 = (0x3x0) in node[marble,diamond,yellow] (4x2) at (\x1+1.6cm,0) {};
  \path let \p1 = (0x3x0) in node[marble,diamond,yellow] (5x2) at (\x1+2.35cm,0) {};
