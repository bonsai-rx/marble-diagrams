...
\matrix[row sep=0.5cm]
{
  ...
  \node[box,minimum width=6cm,minimum height=0.719cm] (op) {BehaviorSubject};
  \\
  ...
  \draw [time] (2.7,0) -- (6,0);
  \node[marble,hexagon,green] (0x3) [right=0.1 of Sx3] {};
  \node[marble,hexagon,blue] (2x3) [right=0.7 of Sx3] {};
