...
\matrix[row sep=0.5cm,font=\sffamily]
{
  ...
  \node[marble,circle,red] (2x0) at (3,0) {};
  \node[marble,circle,cyan] (3x0) at (4,0) {};
  \node[marble,circle,blue] (4x0) at (5,0) {};
  \node[marble,circle,yellow] (5x0) at (6,0) {};
  \node[complete] (6x0) at (6.5,0) {};
  \\
  
  \node[box,minimum width=6.95cm] (op) {Distinct};
  \\
  
  \draw [time] (0,0) -- (7,0);
  \node[marble,circle,red] (0x2) at (1,0) {};
  \node[marble,circle,yellow] (1x2) at (2,0) {};
  \node[marble,circle,cyan] (2x2) at (4,0) {};
  \node[marble,circle,blue] (3x2) at (5,0) {};
