...
{
  \draw [time] (0,0) -- (7,0);
  \node[notification] (0x0) at (1,0) {onNext \tikz[baseline=-1mm] \node[marble,circle,red] {};};
  \node[notification] (1x0) at (3,0) {onNext \tikz[baseline=-1mm] \node[marble,circle,green] {};};
  \node[notification] (2x0) at (5.25,0) {onCompleted};
  \node[complete] (3x0) at (6.5,0) {};
  \\
  
  \node[box,minimum width=7cm] (op) {Dematerialize};
  \\

  \draw [time] (0,0) -- (7,0);
  \node[marble,circle,red] (0x2) at (1,0) {};
  \node[marble,circle,green] (1x2) at (3,0) {};
  \node[complete] (2x2) at (5.25,0) {};
  \\
};
